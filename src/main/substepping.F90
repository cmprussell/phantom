...
!old version, when accrete was part of kick
    ...
    if (.not.isdead_or_accreted(xyzh(4,i))) then
       ...
       if (iexternalforce > 0) then
          ...
          if (was_accreted) then
             ...
             !This next line was not in the older version of the code.
             !I don't think it affects anything with galcen or cwb sims, but worth checking.
             cycle accreteloop
          endif
       endif
       !
...
#else
             call ptmass_accrete(1,      1,xi,yi,zi,xyzh(4,i),pxyzu(1,i),pxyzu(2,i),pxyzu(3,i),&
#endif
